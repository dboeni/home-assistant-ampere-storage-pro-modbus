...
SENSOR_TYPES: dict[str, list[AmpereModbusSensorEntityDescription]] = {
    ...
    "TotalSysPower": AmpereModbusSensorEntityDescription(
        name="Total Sys Power",
        key="totalsyspower",
        native_unit_of_measurement=UnitOfPower.WATT,
        icon="mdi:solar-power",
        device_class=SensorDeviceClass.POWER,
    ...
    "DailyGridBought": AmpereModbusSensorEntityDescription(
        name="Daily Grid FeedIn",
        key="todaygridbought",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        icon="mdi:solar-power",
        device_class=SensorDeviceClass.ENERGY,
    ...
    "MonthlyGridBought": AmpereModbusSensorEntityDescription(
        name="Monthly Grid FeedIn",
        key="monthgridbought",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        icon="mdi:solar-power",
        device_class=SensorDeviceClass.ENERGY,
    ...
    "YearlyGridBought": AmpereModbusSensorEntityDescription(
        name="Yearly Grid FeedIn",
        key="yeargridbought",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        icon="mdi:solar-power",
        device_class=SensorDeviceClass.ENERGY,
    ...
    "TotalGridBought": AmpereModbusSensorEntityDescription(
        name="Total Grid FeedIn",
        key="totalgridbought",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        icon="mdi:solar-power",
        device_class=SensorDeviceClass.ENERGY,
    ...
    "DailyGridSold": AmpereModbusSensorEntityDescription(
        name="Daily Grid FeedOut",
        key="todaygridsold",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        icon="mdi:solar-power",
        device_class=SensorDeviceClass.ENERGY,
    ...
    "MonthlyGridSold": AmpereModbusSensorEntityDescription(
        name="Monthly Grid FeedOut",
        key="monthgridsold",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        icon="mdi:solar-power",
        device_class=SensorDeviceClass.ENERGY,
    ...
    "YearlyGridSold": AmpereModbusSensorEntityDescription(
        name="Yearly Grid FeedOut",
        key="yeargridsold",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        icon="mdi:solar-power",
        device_class=SensorDeviceClass.ENERGY,
    ...
    "TotalGridSold": AmpereModbusSensorEntityDescription(
        name="Total Grid FeedOut",
        key="totalgridsold",
        native_unit_of_measurement=UnitOfEnergy.KILO_WATT_HOUR,
        icon="mdi:solar-power",
        device_class=SensorDeviceClass.ENERGY,
